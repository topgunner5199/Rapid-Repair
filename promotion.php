<?php
    ...
    if($_POST['mode'] == "search"){
        $query = " 
                SELECT PROMO_ID AS 'ID', PROMO_NAME AS 'Promo Name', EXPIRATION AS Expiration, PROMO_TYPE AS 'Promotion Type'
                FROM PROMOTIONS
    ...
    $table_fields = 
    array("PROMO_ID", "PROMO_NAME", "EXPIRATION", "PROMO_TYPE");
...
<section class="table">
    ...
    <a href="http://rapidresponseauto.info/add/add_<?php echo $table?>.php"><button>Add Promotion</button></a>
