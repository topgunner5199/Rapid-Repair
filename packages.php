<?php
	...
	if($_POST['mode'] == "search"){
        $query = " 
            SELECT PACKAGE_ID AS ID, PACKAGE_NAME AS 'Package Name', PACKAGE_PRICE as 'Package Price'
            FROM PACKAGES
    ...
    $q = $db->prepare("DESCRIBE PACKAGES");
    $q->execute();
...
<section class="table">
	...
	<h1>Packages</h1>
    <a href="http://rapidresponseauto.info/add/add_<?php echo $table?>.php"><button>Add Package</button></a>
